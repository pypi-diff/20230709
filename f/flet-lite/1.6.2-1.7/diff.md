# Comparing `tmp/flet_lite-1.6.2.tar.gz` & `tmp/flet_lite-1.7.tar.gz`
...
### Comparing `flet_lite-1.6.2/README.md` & `flet_lite-1.7/README.md`
...
### Comparing `flet_lite-1.6.2/flet_core/transparent_pointer.py` & `flet_lite-1.7/flet_core/transparent_pointer.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_core/types.py` & `flet_lite-1.7/flet_core/types.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_core/user_control.py` & `flet_lite-1.7/flet_core/user_control.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_core/vertical_divider.py` & `flet_lite-1.7/flet_core/vertical_divider.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_core/view.py` & `flet_lite-1.7/flet_core/view.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_core/window_drag_area.py` & `flet_lite-1.7/flet_core/window_drag_area.py`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/flet_lite.egg-info/PKG-INFO` & `flet_lite-1.7/flet_lite.egg-info/PKG-INFO`
...
### Comparing `flet_lite-1.6.2/flet_lite.egg-info/SOURCES.txt` & `flet_lite-1.7/flet_lite.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `flet_lite-1.6.2/setup.py` & `flet_lite-1.7/setup.py`
