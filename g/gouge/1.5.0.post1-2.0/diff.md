# Comparing `tmp/gouge-1.5.0.post1.tar.gz` & `tmp/gouge-2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/gouge-1.5.0.post1.tar", last modified: Fri Apr  2 14:43:02 2021, max compression
+gzip compressed data, was "gouge-2.0.tar", last modified: Sun Jul  9 10:19:22 2023, max compression
```

## Comparing `gouge-1.5.0.post1.tar` & `gouge-2.0.tar`

### file list

```diff
@@ -1,23 +1,44 @@
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2021-04-02 14:43:02.862777 gouge-1.5.0.post1/
--rw-r--r--   0 runner    (1001) docker     (121)       26 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (121)      777 2021-04-02 14:43:02.862777 gouge-1.5.0.post1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)      729 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/README.rst
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2021-04-02 14:43:02.858777 gouge-1.5.0.post1/gouge/
--rw-r--r--   0 runner    (1001) docker     (121)      121 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/gouge/__init__.py
--rw-r--r--   0 runner    (1001) docker     (121)     4761 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/gouge/colourcli.py
--rw-r--r--   0 runner    (1001) docker     (121)     4200 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/gouge/filters.py
--rw-r--r--   0 runner    (1001) docker     (121)     4770 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/gouge/parseable.py
--rw-r--r--   0 runner    (1001) docker     (121)       12 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/gouge/version.txt
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2021-04-02 14:43:02.862777 gouge-1.5.0.post1/gouge.egg-info/
--rw-r--r--   0 runner    (1001) docker     (121)      777 2021-04-02 14:43:02.000000 gouge-1.5.0.post1/gouge.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (121)      370 2021-04-02 14:43:02.000000 gouge-1.5.0.post1/gouge.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (121)        1 2021-04-02 14:43:02.000000 gouge-1.5.0.post1/gouge.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (121)        9 2021-04-02 14:43:02.000000 gouge-1.5.0.post1/gouge.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (121)        6 2021-04-02 14:43:02.000000 gouge-1.5.0.post1/gouge.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (121)       67 2021-04-02 14:43:02.862777 gouge-1.5.0.post1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (121)     1118 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (121)        0 2021-04-02 14:43:02.862777 gouge-1.5.0.post1/test/
--rw-r--r--   0 runner    (1001) docker     (121)      374 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/test/test_caplog.py
--rw-r--r--   0 runner    (1001) docker     (121)      614 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/test/test_coloring.py
--rw-r--r--   0 runner    (1001) docker     (121)     1527 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/test/test_colourcli.py
--rw-r--r--   0 runner    (1001) docker     (121)     6411 2021-04-02 14:43:00.000000 gouge-1.5.0.post1/test/test_shifting_filter.py
...
### Comparing `gouge-1.5.0.post1/README.rst` & `gouge-2.0/README.rst`

 * *Files identical despite different names*

### Comparing `gouge-1.5.0.post1/gouge/colourcli.py` & `gouge-2.0/src/gouge/colourcli.py`
...
### Comparing `gouge-1.5.0.post1/gouge/filters.py` & `gouge-2.0/src/gouge/filters.py`
...
### Comparing `gouge-1.5.0.post1/gouge/parseable.py` & `gouge-2.0/src/gouge/parseable.py`
...
### Comparing `gouge-1.5.0.post1/setup.py` & `gouge-2.0/pyproject.toml`
...
### Comparing `gouge-1.5.0.post1/test/test_coloring.py` & `gouge-2.0/test/test_coloring.py`

 * *Files identical despite different names*

### Comparing `gouge-1.5.0.post1/test/test_colourcli.py` & `gouge-2.0/test/test_colourcli.py`
...
### Comparing `gouge-1.5.0.post1/test/test_shifting_filter.py` & `gouge-2.0/test/test_shifting_filter.py`
