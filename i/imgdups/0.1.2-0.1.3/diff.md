# Comparing `tmp/imgdups-0.1.2.tar.gz` & `tmp/imgdups-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "imgdups-0.1.2.tar", last modified: Wed Jul  5 17:33:28 2023, max compression
+gzip compressed data, was "imgdups-0.1.3.tar", last modified: Sun Jul  9 16:52:48 2023, max compression
```

## Comparing `imgdups-0.1.2.tar` & `imgdups-0.1.3.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxrwxr-x   0 nice      (1000) nice      (1000)        0 2023-07-05 17:33:28.352523 imgdups-0.1.2/
--rw-rw-r--   0 nice      (1000) nice      (1000)    35149 2023-07-03 20:54:00.000000 imgdups-0.1.2/LICENSE
--rw-rw-r--   0 nice      (1000) nice      (1000)     2484 2023-07-05 17:33:28.352523 imgdups-0.1.2/PKG-INFO
--rw-r--r--   0 nice      (1000) nice      (1000)     1508 2023-07-04 17:37:18.000000 imgdups-0.1.2/README.md
-drwxrwxr-x   0 nice      (1000) nice      (1000)        0 2023-07-05 17:33:28.352523 imgdups-0.1.2/imgdups/
--rw-rw-r--   0 nice      (1000) nice      (1000)      114 2023-07-04 16:54:42.000000 imgdups-0.1.2/imgdups/__init__.py
--rwxrwxr-x   0 nice      (1000) nice      (1000)    10948 2023-07-04 16:12:21.000000 imgdups-0.1.2/imgdups/imgdups.py
-drwxrwxr-x   0 nice      (1000) nice      (1000)        0 2023-07-05 17:33:28.352523 imgdups-0.1.2/imgdups.egg-info/
--rw-rw-r--   0 nice      (1000) nice      (1000)     2484 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/PKG-INFO
--rw-rw-r--   0 nice      (1000) nice      (1000)      316 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/SOURCES.txt
--rw-rw-r--   0 nice      (1000) nice      (1000)        1 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/dependency_links.txt
--rw-rw-r--   0 nice      (1000) nice      (1000)       49 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/entry_points.txt
--rw-rw-r--   0 nice      (1000) nice      (1000)       20 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/requires.txt
--rw-rw-r--   0 nice      (1000) nice      (1000)        8 2023-07-05 17:33:28.000000 imgdups-0.1.2/imgdups.egg-info/top_level.txt
--rw-rw-r--   0 nice      (1000) nice      (1000)        1 2023-07-04 16:37:56.000000 imgdups-0.1.2/imgdups.egg-info/zip-safe
--rw-rw-r--   0 nice      (1000) nice      (1000)       82 2023-07-03 21:28:15.000000 imgdups-0.1.2/pyproject.toml
--rw-rw-r--   0 nice      (1000) nice      (1000)       38 2023-07-05 17:33:28.352523 imgdups-0.1.2/setup.cfg
--rw-rw-r--   0 nice      (1000) nice      (1000)     1613 2023-07-04 18:48:25.000000 imgdups-0.1.2/setup.py
-drwxrwxr-x   0 nice      (1000) nice      (1000)        0 2023-07-05 17:33:28.352523 imgdups-0.1.2/tests/
--rw-rw-r--   0 nice      (1000) nice      (1000)      166 2023-07-04 17:05:07.000000 imgdups-0.1.2/tests/test_imgdups.py
...
### Comparing `imgdups-0.1.2/LICENSE` & `imgdups-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `imgdups-0.1.2/PKG-INFO` & `imgdups-0.1.3/PKG-INFO`
...
### Comparing `imgdups-0.1.2/README.md` & `imgdups-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `imgdups-0.1.2/imgdups/imgdups.py` & `imgdups-0.1.3/imgdups/imgdups.py`
...
### Comparing `imgdups-0.1.2/imgdups.egg-info/PKG-INFO` & `imgdups-0.1.3/imgdups.egg-info/PKG-INFO`
...
### Comparing `imgdups-0.1.2/setup.py` & `imgdups-0.1.3/setup.py`
