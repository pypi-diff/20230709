# Comparing `tmp/ngmapi-0.0.43.tar.gz` & `tmp/ngmapi-0.0.44.tar.gz`
...
## Comparing `ngmapi-0.0.43.tar` & `ngmapi-0.0.44.tar`
...
### Comparing `ngmapi-0.0.43/pyproject.toml` & `ngmapi-0.0.44/pyproject.toml`
