# Comparing `tmp/process-twarc-0.12.tar.gz` & `tmp/process-twarc-0.12.1.tar.gz`
...
## Comparing `process-twarc-0.12.tar` & `process-twarc-0.12.1.tar`
...
### Comparing `process-twarc-0.12/LICENSE.txt` & `process-twarc-0.12.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `process-twarc-0.12/PKG-INFO` & `process-twarc-0.12.1/PKG-INFO`
...
### Comparing `process-twarc-0.12/process_twarc/util.py` & `process-twarc-0.12.1/process_twarc/util.py`
...
### Comparing `process-twarc-0.12/process_twarc.egg-info/PKG-INFO` & `process-twarc-0.12.1/process_twarc.egg-info/PKG-INFO`
...
### Comparing `process-twarc-0.12/setup.py` & `process-twarc-0.12.1/setup.py`
