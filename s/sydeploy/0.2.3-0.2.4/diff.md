# Comparing `tmp/sydeploy-0.2.3-py3-none-any.whl.zip` & `tmp/sydeploy-0.2.4-py3-none-any.whl.zip`
...
## Comparing `sydeploy-0.2.3.dist-info/LICENSE` & `sydeploy-0.2.4.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `sydeploy-0.2.3.dist-info/RECORD` & `sydeploy-0.2.4.dist-info/RECORD`
