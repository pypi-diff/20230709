# Comparing `tmp/sydeploy-0.2.6-py3-none-any.whl.zip` & `tmp/sydeploy-0.2.7-py3-none-any.whl.zip`
...
## Comparing `sydeploy-0.2.6.dist-info/LICENSE` & `sydeploy-0.2.7.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `sydeploy-0.2.6.dist-info/RECORD` & `sydeploy-0.2.7.dist-info/RECORD`
