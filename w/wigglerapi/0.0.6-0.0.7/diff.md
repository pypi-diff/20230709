# Comparing `tmp/wigglerapi-0.0.6.tar.gz` & `tmp/wigglerapi-0.0.7.tar.gz`
...
## Comparing `wigglerapi-0.0.6.tar` & `wigglerapi-0.0.7.tar`
...
### Comparing `wigglerapi-0.0.6/setup.py` & `wigglerapi-0.0.7/setup.py`
...
### Comparing `wigglerapi-0.0.6/wigglerapi/main.py` & `wigglerapi-0.0.7/wigglerapi/main.py`
